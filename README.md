...
Entenda o que acontece no commit e no push com a imagem a seguir:
![Areas e comandos git](gitEstagiosRepositorioLocal.png)
...
Veja o exemplo um processo de criação, implementação e merge de uma branch: 
![Branches git](gitMergeNewBranch.png)
...
👊 Vamos fazer um fork deste repositório na sua máquina? Clique em fork e veja que ele passa a ser duplicado na sua conta pessoal além de estar organização de origem.
...
👊 Vamos criar uma issue para o repositório que você fez um fork? Atenção onde a issue está sendo criada. Essa parte é confusa mesmo. Lembre que você fez uma duplicação (fork) na sua conta pessoa. 
...
👊 Aproveite para favoritar este repositório. 
...
👊 Busque seus colegas no GitHub para segui-los.
